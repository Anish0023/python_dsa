'''
Return the maximum count of positive or negative integers in a sorted array.
The array is sorted in non-decreasing order and may contain zeros.
Find the solution in O(log n) time complexity.
'''
class Solution:
